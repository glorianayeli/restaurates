<div class="row mb-5">
    ...
    <div class="col-12 col-md-4">
        <div class="btn-group">
            <a href="<?php echo base_url() ?>TipoComida/Formulario" class="b tn btn-secondary btn-sm">
                <span class="fas fa-plus-square"></span> Nuevo
            </a>
        </div>
    </div>
</div>
<div class="row">
    <?php if(isset($response)):?>
        ...
        <?php echo($response['done'] ? 'success' : 'danger') ?> text-center col-12">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <?php if($tipo['totalPlatillos'] == 0): ?>
                            <button href="<?php echo(base_url('TipoComida/El iminar/'.$tipo['ti_id'])); ?>" class="btn btn-danger btn-sm btn-eliminar">
